...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header text-center">Project Unknown
            <small>International Space Apps Challenge 2015</small>
            </h1>
        </div>
    </div>
    <!-- /.row -->
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        <a href="https://projectunkown-vcabieles.c9.io/" target="_blank">
                            <img class="img-responsive" src="/assets/images/projectUnknownMain750x500.png" alt="nasa project_unknown spaceapps_challenge">
                        </a>
                    </div>
                    <div class="item">
                        <a href="https://projectunkown-vcabieles.c9.io/" target="_blank">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <h3 class="page-header text-center">Press Information: </h3>
        </div>

        <div class="col-lg-4 col-sm-4 col-xs-12">
            <a href="http://spaceappsksc.tumblr.com/post/116303202714/space-apps-weekend-in-central-florida" target="_blank">
                <img class="img-responsive img-hover img-related" src="/assets/images/LakeEola.jpg" alt="nasa space_Apps_Challenge_2015 full_Sail_University">
            </a>
        </div>
